            ...
            <?= $this->section('scripts') ?>
                ...
                <script>
                    ...
                    function refreshButtonState() {
                        fetch('<?= base_url('admin/attendance/last-status') ?>')
                            .then(res => res.json())
                            .then(res => {
                                lastCheckType = res.last_check_type;
                                applyButtonState();
                            });
                    }

                    function applyButtonState() {
                        if (lastCheckType === 'Masuk') {
                            btnIn.disabled  = true;
                            btnOut.disabled = false;
                        } 
                        else if (lastCheckType === 'Pulang') {
                            btnIn.disabled  = true;
                            btnOut.disabled = true;
                        } 
                        else {
                    ...
                    document.addEventListener('DOMContentLoaded', refreshButtonState);
                ...
                <?php if (!empty($alreadyDone) && $alreadyDone): ?>
                    <script>
