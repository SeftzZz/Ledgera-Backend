                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card card-primary card-outline">
                                        ...
                                        <form method="post" action="<?= base_url('admin/employees/update/'.$employee['id']) ?>" enctype="multipart/form-data">
                                            <?= csrf_field() ?>
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="employee_code" id="employee_code" class="form-control" value="<?= esc($employee['employee_code']) ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <label for="prefix_title">Gelar Depan</label>
                                                        <input name="prefix_title" id="prefix_title" class="form-control" value="<?= esc($employee['prefix_title']) ?>">
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            <label for="full_name">Nama Lengkap</label>
                                                            <input name="full_name" id="full_name" class="form-control" value="<?= esc($employee['full_name']) ?>">
                                                            <small style="color:red"><?= session('errors.full_name') ?></small>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            <label for="suffix_title">Gelar Belakang</label>
                                                            <input name="suffix_title" id="suffix_title" class="form-control" value="<?= esc($employee['suffix_title']) ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="nick_name" id="nick_name" class="form-control" value="<?= esc($employee['nick_name']) ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="idcard_no" id="idcard_no" class="form-control" value="<?= esc($employee['idcard_no']) ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="nationality" id="nationality" class="form-control" value="<?= esc($employee['nationality']) ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            <label for="place_birth">Tempat Lahir</label>
                                                            <input name="place_birth" id="place_birth" class="form-control" value="<?= esc($employee['place_birth']) ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group date" id="tgllahir" data-target-input="nearest">
                                                                <input type="text" name="date_birth" id="date_birth" class="form-control datetimepicker-input" value="<?= esc($employee['date_birth']) ?>" data-target="#tgllahir" data-toggle="datetimepicker"/>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="address" id="address" class="form-control" rows="3"><?= esc($employee['address']) ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="city" id="city" class="form-control" value="<?= esc($employee['city']) ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            <label for="zip_code">Kodepos</label>
                                                            <input name="zip_code" id="zip_code" class="form-control" value="<?= esc($employee['zip_code']) ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            <label for="email">Email</label>
                                                            <input name="email" id="email" class="form-control" value="<?= esc($employee['email']) ?>">
                                                            <small style="color:red"><?= session('errors.email') ?></small>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            <label for="hp">No. HP</label>
                                                            <input name="hp" id="hp" class="form-control" value="<?= esc($employee['hp']) ?>">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="marital" id="marital" class="form-control" value="<?= esc($employee['marital_id']) ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            <label for="pendidikan">Pendidikan Terakhir</label>
                                                            <input name="pendidikan" id="pendidikan" class="form-control" value="<?= esc($employee['education_id']) ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            <label for="jabatan">Jabatan</label>
                                                            <input name="jabatan" id="jabatan" class="form-control" value="<?= esc($employee['position']) ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group date" id="tglgabung" data-target-input="nearest">
                                                                <input type="text" name="join_date" id="join_date" class="form-control datetimepicker-input" value="<?= esc($employee['join_date']) ?>" data-target="#tglgabung" data-toggle="datetimepicker"/>
                                                    ...
                                                    <div id="drop-area" class="drop-area" style="border:2px dashed #ccc;padding:20px;text-align:center;cursor:pointer;">
                                                        ...
                                                        <img id="preview"
                                                             src="<?= $employee['picture']
                                                                ? base_url('uploads/fotopegawai/'.$employee['picture'])
                                                                : base_url('assets/themes/dist/img/user-default.jpg') ?>"
                                                             style="max-width:100%;max-height:300px;">
                                                    </div>

                                                    <input type="file" id="fileInput" name="picture" accept="image/*" hidden>
                                                    <input type="hidden" name="picture" id="picture" value="<?= esc($employee['picture']) ?>">
            ...
            <?= $this->section('scripts') ?>
                ...
                <script>
                    ...
                    document.getElementById('cropBtn').addEventListener('click', function () {
                        ...
                        $.post("<?= base_url('admin/employees/upload-photo') ?>", {
                            image: imageData,
